...
public class DatabaseContract
{
    ...
    public static final class scores_table implements BaseColumns
    {
        ...
        public static Cursor buildScore(Context context){
            ScoresDBHelper scoresDBHelper = new ScoresDBHelper(context);
            SQLiteDatabase sqLiteDatabase = scoresDBHelper.getReadableDatabase();

            Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM scores_table", null);
            return cursor;
        }
    }
    //URI data
